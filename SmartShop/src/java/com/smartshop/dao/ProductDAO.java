...
import java.sql.*; import java.util.*; import java.math.BigDecimal;
public class ProductDAO {
    ...
    public int countAll(String q, Integer categoryId, String brand, String color, BigDecimal minPrice, BigDecimal maxPrice){
    ...
    public List<Product> search(String q, Integer categoryId, String brand, String color, BigDecimal minPrice, BigDecimal maxPrice, String sort, int offset, int limit){
