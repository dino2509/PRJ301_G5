...
public class AuthController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (p) {
            ...
            case "/reset" -> showReset(req, resp);                     // ĐÃ CHẶN BƯỚC NÀY
            case "/account" -> showAccount(req, resp);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (p) {
            ...
            case "/forgot" -> doForgot(req, resp);                     // GỬI MÃ hoặc XÁC MINH MÃ
            case "/reset" -> doReset(req, resp);                       // ĐỔI MẬT KHẨU (yêu cầu token+email)
    ...
    private void doReset(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (isBlank(token) || isBlank(email)) { resp.sendRedirect(req.getContextPath()+"/forgot"); return; }
    ...
    private boolean isDefaultPort(HttpServletRequest req) {
        int p = req.getServerPort(); String sch = req.getScheme();
