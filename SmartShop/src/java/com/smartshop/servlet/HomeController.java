...
public class HomeController extends HttpServlet {
    ...
    @Override protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{ if(req.getParameter("min")!=null) min=new java.math.BigDecimal(req.getParameter("min")); }catch(Exception ignored){}
        try{ if(req.getParameter("max")!=null) max=new java.math.BigDecimal(req.getParameter("max")); }catch(Exception ignored){}
        int page=1, size=10;
